...
class Question extends \Wafl\Extensions\Communication\AnswersAdmin\Models\DataModel\Question
{
    ...
    public function GetCategory()
    {
        if ($this->_categoryId)
        {
            return new \Wafl\Extensions\Communication\Answers\Models\FunctionalModel\Category($this->_categoryId);
        } else {
            return null;
        }
    }
